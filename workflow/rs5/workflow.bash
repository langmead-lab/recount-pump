...
# salmon_args (extra params for salmon, default '')
...
# hisat2_args (extra params for hisat2 unaligned run, default '')
# max_unalign (limit on number of unaligned to primary ref [hg38...] read/read pairs to save, default 100000)
